...
As it can be seen *google* has 9 submissions with an average score of 7.5, and the biggest cluster is of 13 submissions with an average score of 6. Note that the *google* domain may contain *deep mind, google brain* and *google research* submissions. Before the reader thinks about the impartiality of these results, I would like to clarify that I am not vinculated to *google*.
