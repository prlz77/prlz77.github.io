...
other in the time domain. Performing these extensions in tiny-dnn is specially
...
- Gradient checks were initially thought to work on the whole network, comparing
  ...
  new [blackbox gradient check](https://github.com/tiny-dnn/tiny-dnn/pull/846),
...
1. Creating a functionall rnn cell.
